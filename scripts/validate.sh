...
check_file "scripts/check-consistency-full.sh"
...
check_executable "scripts/check-consistency-full.sh"
...
check_bash_syntax "scripts/check-consistency-full.sh"
